                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center py-4">
                        ...
                        <Link to="/icse-primary" className="flex items-center space-x-3">
                            <div className="bg-gradient-to-br from-blue-600 to-primary w-12 h-12 rounded-xl flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-600">Grades 1 to 5 • CISCE Affiliated</p>
                            </div>
                        </Link>
