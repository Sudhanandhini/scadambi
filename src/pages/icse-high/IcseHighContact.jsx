...
import { Mail, Phone, MapPin, Clock, Facebook, User, ArrowRight } from 'lucide-react';
                  ...
                  {info.details.map((detail, idx) => (
                    info.links[idx] ? (
                      <a 
                        key={idx} 
                        href={info.links[idx]} 
                        className="block text-gray-700 hover:text-[#FDB913] transition-colors font-medium"
                      >
                        {detail}
                      </a>
                    ) : (
