...
const IcseHighHeader = () => {
    ...
    const navItems = [
        ...
        { name: 'Activites', path: '/icse-high/activites' },
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center py-4">
                        ...
                        <Link to="/icse-high" className="flex items-center space-x-3">
                            <div className="bg-gradient-to-br from-[#0F2A4A] to-[#1a4d7a] w-12 h-12 rounded-xl flex items-center justify-center">
                                <span className="text-white font-bold text-xl">🎓</span>
                            </div>
                            <div>
                                <h1 className="text-xl font-bold text-[#0F2A4A] leading-tight">ICSE High School</h1>
                                <p className="text-xs text-gray-600">Grades 6 to 10 • CISCE Affiliated</p>
                            </div>
                        </Link>
