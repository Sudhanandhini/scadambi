                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    <div>
                        <div className="flex items-center space-x-3 mb-6">
                            <div className="bg-[#FDB913] w-12 h-12 rounded-xl flex items-center justify-center">
                                <span className="text-2xl">🎓</span>
                            </div>
                            <div>
                                <h3 className="text-xl font-bold">ICSE High School</h3>
                                <p className="text-sm text-white/80">Grades 6-10</p>
                            </div>
                        </div>
